import svgPaths from "./svg-2ecqxs6dbp";
import svgPaths from "./svg-2ecqxs6dbp";
...
function AboutSection() {
  return (
    <div id="sobre-mi" className="bg-white content-stretch flex gap-[32px] items-start relative shrink-0 w-[1104px]" data-name="AboutSection">
      <Container13 />
      <Frame69 />
    </div>
  );
