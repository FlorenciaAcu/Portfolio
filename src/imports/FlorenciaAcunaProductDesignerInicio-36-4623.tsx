import svgPaths from "./svg-i9ago77i3f";
...
function HeroSection() {
  return (
    <div className="bg-white content-stretch flex gap-[20px] items-center relative shrink-0 w-[1104px]" data-name="HeroSection">
      <Container4 />
...
function AboutSection() {
  return (
    <div className="bg-white content-stretch flex gap-[32px] items-start relative shrink-0 w-[1104px]" data-name="AboutSection">
      <Container13 />
      <Frame69 />
    </div>
  );
...
function Container36() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start overflow-clip relative rounded-bl-[16px] rounded-tl-[16px] shrink-0 size-[500px]" data-name="Container">
      <div className="basis-0 grow min-h-px min-w-px relative rounded-[16px] shrink-0 w-full" data-name="image 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[16px]">
          <img alt="" className="absolute h-[100.89%] left-0 max-w-none top-[-0.45%] w-[227.63%]" src={imgImage1} />
        </div>
      </div>
    </div>
  );
...
function ContactSection1() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[64px] items-start px-[24px] py-0 relative shrink-0 w-[1104px]" data-name="ContactSection">
      <Container56 />
      <Container66 />
    </div>
  );
