import svgPaths from "./svg-fijp8wjvs1";
...
function AboutSection() {
  return (
    <div className="bg-white content-stretch flex gap-[32px] items-start overflow-clip relative shrink-0 w-[1104px]" data-name="AboutSection">
      <Container13 />
      <Frame69 />
    </div>
  );
